...
const PAGE_PATH = "/faq/";
const PAGE_TITLE = "FAQs | Brighter Launchpad";
const PAGE_DESCRIPTION =
  "Answers for families about programs, hours, and enrolment, and for prospective owners about franchising with Brighter Launchpad.";

const breadcrumbSchema = buildBreadcrumbSchema([
  { name: "Home", path: "/" },
  { name: "FAQs", path: PAGE_PATH },
]);

// Plain-text mirror of the FAQ copy below (some answers render as JSX with
// links, which JSON-LD can't hold) — used only to build FAQPage schema.
const faqSchemaEntries = [
  ...
  },
  {
    ...
    a: "We currently operate centres across New Brunswick under the A2Z Learning & Care, Beautiful Beginnings, Brighter Horizon, and Serious Fun brands. See our locations page for addresses and directions.",
  },
  {
    q: "How do I enrol my child?",
    a: "Start by reaching out through our contact page to book a tour — we'll walk you through availability, routines, and next steps for your child's age group.",
  },
  {
...
const faqPageSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: faqSchemaEntries.map(({ q, a }) => ({
    "@type": "Question",
    name: q,
    acceptedAnswer: {
      "@type": "Answer",
