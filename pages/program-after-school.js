...
const PAGE_TITLE = "After-School Program | Brighter Launchpad";
const PAGE_DESCRIPTION = `${program.tagline} For ${program.ageRange.toLowerCase()}, at our New Brunswick centres.`;
